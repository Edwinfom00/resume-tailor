...
export const messages = {
  ...
  studio: {
    ...
    copilot: {
      ...
      workingWithLabel: "Sie arbeiten mit",
      chatLabel: "Chat",
      actionsLabel: "Aktionen",
      assistantLabel: "Copilot",
      userLabel: "Sie",
      greeting: "Hallo Edwin! 👋",
      greetingPrompt: "Ich kann Ihnen helfen, Ihren Lebenslauf für diese Stelle anzupassen. Was möchten Sie verbessern?",
      sampleUserMessage: "Machen Sie meine Softronic-Erfahrung für diese Stelle relevanter.",
      improvementsFoundLabel: "Ich habe 3 wirkungsvolle Verbesserungen gefunden.",
      suggestedChangeTitle: "Softronic Innoving · Full-Stack-Entwickler",
      changedBulletsLabel: "3 Stichpunkte werden aktualisiert",
      impactLabel: "+12 % Wirkung",
      changeBullets: [
        "Full-Stack-Anwendungen mit Next.js, Node.js, Prisma ORM und Microsoft SQL Server entwickeln und warten.",
        "REST-API-Integrationen erstellen und Datenabfragen mit Microsoft SQL Server optimieren.",
        "Skalierbare Frontend- und Backend-Lösungen mit Next.js und Node.js entwickeln.",
      ],
      ...
      editLabel: "Bearbeiten",
      ignoreLabel: "Ignorieren",
      quickActionsLabel: "Weitere schnelle Aktionen",
      improveProfileLabel: "Profil verbessern",
      reorderProjectsLabel: "Projekte neu anordnen",
      addExperienceLabel: "Erfahrung hinzufügen",
      addSkillsLabel: "Kenntnisse hinzufügen",
      optimizeForJobLabel: "Für diese Stelle optimieren",
      moreActionsLabel: "Weitere Aktionen",
      composerPlaceholder: "Resume Copilot fragen...",
      attachLabel: "Datei anhängen",
      sendLabel: "Nachricht senden",
      reviewNotice: "Copilot kann Fehler machen. Prüfen Sie die Änderungen vor dem Anwenden.",
      responseMessage: "Ich habe dies zur Prüfung in die Empfehlungsliste aufgenommen.",
