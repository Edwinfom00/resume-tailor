  ...
  return (
    <>
      <form onSubmit={handleSave} className="space-y-5">
        ...
        <div className="max-h-[380px] space-y-4 overflow-y-auto pr-1.5 scrollbar-thin">
                ...
                <div className="space-y-1">
                  ...
                  <div className="flex items-center gap-3">
                    <input
                      ...
                      className="w-full rounded-xl border border-line-subtle bg-canvas px-3 py-2 text-sm text-ink outline-none focus:border-brand focus:ring-2 focus:ring-brand/20 transition-all shadow-2xs disabled:opacity-50"
                    />
